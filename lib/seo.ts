...
export const SITE = {
	...
	description:
		"Full Stack Developer with 4+ years building scalable web & mobile applications. Expertise in web development, UI/UX design, AI and ML. Available for freelance projects.",
