/* Shared SVG icon set — used by the client portal and admin.
   All icons inherit `currentColor`. Sizes are sensible defaults; override
   with CSS (svg { width/height }) where needed. */
...
export const Icons = {
  ...
  /* ── Extras for admin + the new sidebar shell ── */
  Menu: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
