				...
				<div className="container">
					<div className="row">
						...
						<div className="d-flex flex-wrap flex-lg-nowrap justify-content-center gap-3 mb-7 px-6">
							...
							<div className="skills">
								...
								<div className="skills-ratio text-center">
									...
									<p className="text-400 fw-medium text-uppercase">DJNAGO</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
						...
						<div className="text-center">
							<p className="fs-5 text-200 mb-0">In addition, I have also some more programming knowledge such as: </p>
