				...
				<div className="container position-relative z-3">
					<div className="row">
						<div className="col-lg-6 col-md-12">
							...
							<h1 className="ds-2 mb-3">Full stack Developer <span className="text-primary"></span></h1>
							<p className="text-300 mb-6">A full stack developer is skilled in both front-end and back-end technologies, enabling them to build, deploy, and maintain complete web applications. They handle everything from the user interface and experience to server-side logic, databases, and API integrations.</p>
							...
							<p className="text-400 mt-6 mb-3">+ 2 years with professional Web Developer</p>
